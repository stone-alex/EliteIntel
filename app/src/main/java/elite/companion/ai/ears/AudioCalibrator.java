...
public class AudioCalibrator {
    ...
    public static AudioSettingsTuple<Double, Double> calibrateRMS(int sampleRateHertz, int bufferSize) {
        ...
        EventBusManager.publish(new elite.companion.gameapi.VoiceProcessEvent("Please speak for a few seconds to calibrate audio..."));
        ...
        try (TargetDataLine line = (TargetDataLine) AudioSystem.getLine(info)) {
            ...
            EventBusManager.publish(new VoiceProcessEvent("Audio calibration failed. Using default settings."));
            ...
            EventBusManager.publish(new VoiceProcessEvent("Audio calibration complete."));
        }
