...
public enum QueryActions {
    ...
    QUERY_PIRATE_KILLS_REMAINING("query_pirate_kills_remaining", "Summarize the state of the pirate massacre missions", PirateMissionAnalyzer.class, true),
    QUERY_PIRATE_MISSION_PROFIT("query_pirate_mission_profit", "Summarize the potential profit from currently active pirate massacre missions", PirateMissionAnalyzer.class, true),
    QUERY_PIRATE_STATUS("query_pirate_status", "Handles summarize current progression of pirate massacre missions", PirateMissionAnalyzer.class, true),
