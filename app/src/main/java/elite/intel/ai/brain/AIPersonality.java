...
public enum AIPersonality {
    ...
    UNHINGED("Respond briefly  and concisely with playful, cheeky energy, emphasizing humor and light sarcasm. Use jargon and slang that matches cadence."),
    ROGUE("Respond briefly and concisely with bold, in-your-face energy, using heavy jargon, profanity and slang but staying sharp and witty within the selected cadence.");
