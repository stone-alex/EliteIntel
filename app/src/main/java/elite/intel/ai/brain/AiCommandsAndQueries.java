...
public class AiCommandsAndQueries {
    ...
    private final Map<String, String> commandMap = Map.<String, String>ofEntries(
            ...
            Map.entry(" find star system where we can mine material X ", FIND_MINING_SITE.getAction()),
            ...
            Map.entry(" find commodity X, where can we buy X ", FIND_COMMODITY.getAction()),
            ...
            Map.entry(" display contacts panel, show contacts panel, show contacts, display left panel ", DISPLAY_CONTACTS_PANEL.getAction()),
            ...
            Map.entry(" turn on night vision ", NIGHT_VISION_ON.getAction()),
            Map.entry(" turn off night vision ", NIGHT_VISION_OFF.getAction()),
    ...
    private final Map<String, String> queryMap = Map.ofEntries(
            ...
            Map.entry(" queries about route, can we get fuel at next star/stop/waypoint, what class is the next star, are there any traffic or casualties on route ", PLOTTED_ROUTE_ANALYSIS.getAction()),
            Map.entry(" queries about fleet carrier route (do not confuse with ship route), how long will it take for carrier to reach final destination ", CARRIER_ROUTE_ANALYSIS.getAction()),
            Map.entry(" queries about fleet carrier destination (do not confuse with ship) ", CARRIER_DESTINATION.getAction()),
            Map.entry(" queries about fleet carrier fuel supply (do not confuse with ship) ", CARRIER_TRITIUM_SUPPLY.getAction()),
            Map.entry(" queries about fleet carrier stats, range, finances, funded days of operation V ", CARRIER_STATUS.getAction()),
            Map.entry(" queries about fleet carrier estimated time of arrival (do not confuse with ship) ", CARRIER_ETA.getAction()),
            ...
            Map.entry(" run biome analysis, analyze biome for planet/moon X ", PLANET_BIOME_ANALYSIS.getAction()),
