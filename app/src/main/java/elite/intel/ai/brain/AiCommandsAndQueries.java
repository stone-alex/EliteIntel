...
public class AiCommandsAndQueries {
    ...
    private final Map<String, String> queryMap = Map.ofEntries(
            ...
            Map.entry("queries about route, can we get fuel at next star, what class is the next star, are there any traffic or casualties on route", PLOTTED_ROUTE_ANALYSIS.getAction()),
