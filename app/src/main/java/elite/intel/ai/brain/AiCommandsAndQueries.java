...
public class AiCommandsAndQueries {
    ...
    private final Map<String, String> commandMap = Map.<String, String>ofEntries(
            ...
            Map.entry(" navigate to next mission, set destination for mission type <type>, plot route to mission type <type>. -IF mission type is provided return it in {\"key\":\"mission type\"}", NAVIGATE_TO_NEXT_MISSION.getAction()),
            ...
            Map.entry(" find raw material trader within X light years {\"key\": X}", FIND_RAW_MATERIAL_TRADER.getAction()),
            Map.entry(" find encoded material trader within X light years {\"key\": X}", FIND_ENCODED_MATERIAL_TRADER.getAction()),
            Map.entry(" find manufactured material trader within X light years {\"key\": X} ", FIND_MANUFACTURED_MATERIAL_TRADER.getAction()),
            Map.entry(" find hunting grounds, find where we can hunt pirates within X light years {\"key\": X}", FIND_HUNTING_GROUNDS.getAction()),  // Fixed typo
            ...
            Map.entry(" find human tech broker, find human tech broker within X light years {\"key\": X}", FIND_HUMAN_TECHNOLOGY_BROKER.getAction()),
            Map.entry(" find guardian tech broker, find guardian broker within X light years {\"key\": X}", FIND_GUARDIAN_TECHNOLOGY_BROKER.getAction()),
            Map.entry(" find vista genomics ", FIND_VISTA_GENOMICS.getAction()),
            Map.entry(" find planet with brain trees that contains material X {\"key\": \"material\", \"max_distance\": X}", FIND_BRAIN_TREES.getAction()),
            Map.entry(" find star system where we can mine tritium, find carrier fuel mining site {\"key\": \"tritium\", \"max_distance\": X}", FIND_FLEET_CARRIER_FUEL_MINING_SITE.getAction()),
            Map.entry(" find star system where we can mine material X, find where we can mine silver {\"key\": \"material\", \"max_distance\": X}", FIND_MINING_SITE.getAction()),
            ...
            Map.entry(" find market where we can buy commodity X, where can we buy X, find star system where we can buy tea within X ly {\"key\": \"commodity\", \"max_distance\": X} ", FIND_COMMODITY.getAction()),
