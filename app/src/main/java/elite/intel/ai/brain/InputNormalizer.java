...
public class InputNormalizer {
    ...
    static {
        ...
        SYNONYM_MAP.put("how far am i from civilization", "distance to bubble");
        SYNONYM_MAP.put("how far are we from civilization", "distance to bubble");
        SYNONYM_MAP.put("how far from civilization", "distance to bubble");
        SYNONYM_MAP.put("distance from civilization", "distance to bubble");
        SYNONYM_MAP.put("distance to civilization", "distance to bubble");
        SYNONYM_MAP.put("how far to civilization", "distance to bubble");
        SYNONYM_MAP.put("how far am i from the bubble", "distance to bubble");
        SYNONYM_MAP.put("how far are we from the bubble", "distance to bubble");
        SYNONYM_MAP.put("how far from the bubble", "distance to bubble");
        SYNONYM_MAP.put("how far to the bubble", "distance to bubble");
        SYNONYM_MAP.put("how far am i from inhabited space", "distance to bubble");
        SYNONYM_MAP.put("how far are we from inhabited space", "distance to bubble");
        SYNONYM_MAP.put("how far from inhabited space", "distance to bubble");
        SYNONYM_MAP.put("distance from inhabited space", "distance to bubble");
        SYNONYM_MAP.put("how far from human space", "distance to bubble");
        SYNONYM_MAP.put("how far am i from human space", "distance to bubble");
        SYNONYM_MAP.put("how far are we from human space", "distance to bubble");
        SYNONYM_MAP.put("distance from human space", "distance to bubble");
        SYNONYM_MAP.put("how far am i from the earth", "distance to bubble");
        SYNONYM_MAP.put("how far are we from the earth", "distance to bubble");
        ...
        SYNONYM_MAP.put("how far are we from sol", "distance to bubble");
