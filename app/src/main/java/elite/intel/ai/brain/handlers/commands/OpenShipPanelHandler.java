...
public class OpenShipPanelHandler extends CommandOperator implements CommandHandler {

    public OpenShipPanelHandler(GameController controller) {
    ...
    public void handle(String action, JsonObject params, String responseText) {
        if (status.isInMainShip() || status.isInSrv()) {
            ...
            navigator.openAndNavigate(StatusFlags.GuiFocus.INTERNAL_PANEL, RightPanel.SHIP);
        }
    }
}
