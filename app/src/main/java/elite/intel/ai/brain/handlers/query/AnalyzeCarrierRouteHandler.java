...
public class AnalyzeCarrierRouteHandler extends BaseQueryAnalyzer implements QueryHandler {
    ...
    @Override public JsonObject handle(String action, JsonObject params, String originalUserInput) throws Exception {
        ...
        return process(new DataDto(instructions, fleetCarrierRoute, fuelSupply), originalUserInput);
    }


    private record DataDto(String instructions, Map<Integer, CarrierJump> route, int currentFuelSupply) implements AiData {
