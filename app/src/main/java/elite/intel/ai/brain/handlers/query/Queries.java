...
public enum Queries {
    ...
    SYSTEM_SECURITY_ANALYSIS            ("query_system_security_analysis",   AnalyzeSystemSecurityHandler.class, true),
    ...
    MATERIALS_INVENTORY                 ("query_materials_inventory",        AnalyseMaterialsHandler.class, true),
    ...
    PLANET_MATERIALS                    ("query_location_materials",           AnalyzeMaterialsOnPlanetHandler.class, true),
    ...
    FSD_TARGET_ANALYSIS                 ("query_fsd_target_analysis",        AnalyzeFsdTargetHandler.class, true),
