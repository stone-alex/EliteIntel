...
public enum Queries {
    ...
    QUERY_CARRIERS                      ("query_star_system_for_carriers",              AnalyzeCarriersHandler.class, true),
    ...
    CURRENT_LOCATION                    ("query_current_location_analysis",             AnalyzeCurrentLocationHandler.class, true),
