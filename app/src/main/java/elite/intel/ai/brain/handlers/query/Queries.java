...
public enum Queries {
    ...
    FSD_TARGET_ANALYSIS                 ("analyze_selected_jump_destination",           AnalyzeFsdTargetHandler.class),
    TRADE_ROUTE_ANALYSIS                ("query_trade_schedule_analysis",               AnalyzeTradeScheduleHandler.class),
    ...
    SHIP_LOADOUT                        ("query_ship_loadout_classification",           AnalyzeShipLoadoutHandler.class),
