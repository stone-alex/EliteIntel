...
public enum Queries {
    ...
    QUERY_ANALYZE_ON_BOARD_CARGO("query_ship_cargo_contents", "Use this data provide questions regarding cargo and/or ship loadout if relevant. Cargo is listed 1 unit = 1 ton.", AnalyzeCargoHoldHandler.class, true),  // "ship" to avoid carrier/planet mix-up
    ...
    TARGET_STATION_REMINDER("query_remind_where_the_broker_or_material_trader_station_is_located", "Remind user which station to visit for material trader or technology broker", RemindTargetStationHandler.class, false),
