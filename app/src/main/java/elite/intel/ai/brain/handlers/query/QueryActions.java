...
public enum QueryActions {
    ...
    ANALYZE_SCAN("query_analyze_last_scan", "Provide analysis of this scan data of the stellar object. ", AnalyzeLastScanHandler.class, false),
    ...
    ANALYZE_BODY_MATERIALS("query_planet_materials_for_harvest", "Analyze materials available. ", AnalyzeMaterialsOnPlanetHandler.class, false),
    ANALYZE_CURRENT_FUEL_STATUS("query_fuel_status", "Analyze fuel tank capacity in shipLoadout and fuelData available reserve, provide result as percent fuel available", AnalyzeFuelStatusHandler.class, false),
    ...
    QUERY_ANALYZE_ON_BOARD_CARGO("query_analyze_on_board_cargo", "Analyzes cargo hold contents. ", AnalyzeCargoHoldHandler.class, false),
    QUERY_ANALYZE_ROUTE("query_analyze_route", "Analyze our plotted route. ", AnalyzeRouterHandler.class, false),
    QUERY_CARRIER_STATS("query_carrier_stats", "Summarize carrier information. ", AnalyzeCarrierDataHandler.class, false),
    ...
    QUERY_SEARCH_SIGNAL_DATA("query_signal_local_info", "Analyze information for our current location ", AnalyzeSignalDataHandler.class, false),
    QUERY_SHIP_LOADOUT("query_ship_loadout", "Provide requested information about ship loadout", AnalyzeShipLoadoutHandler.class, false),
