...
public enum QueryActions {
    ...
    QUERY_CARRIER_STATS("query_carrier_stats", "Analyse our fleet carrier data, provide extremely short and concise answer for specific datapoint only, if not specified provide summary", AnalyzeCarrierDataHandler.class, true),
