...
public class FrenchAiActionAliases implements AiActionAliasProvider {
    ...
    public void addAliases(Map<String, String> map, Status status, boolean isDryRun) {
        ...
        map.put("navigue vers le porte-vaisseaux, va au porte-vaisseaux, va au carrier, cap sur le carrier, retourne au carrier, retourne au porte-vaisseaux, ramène-nous au carrier, ramene-nous au carrier", NAVIGATE_TO_CARRIER.getAction());
        ...
        map.put("échantillons exobiologie, echantillons exobiologie, échantillons biologiques, echantillons biologiques, organiques ici, quels organismes, que reste-t-il à scanner, que reste-t-il a scanner, organismes restants, progression exobiologie, organiques sur cette planète, organiques sur cette planete, que devons-nous encore scanner ici, organiques restants à scanner, organiques restants a scanner", EXOBIOLOGY_SAMPLES.getAction());
        ...
        map.put("route carrier, navigation carrier, route de saut carrier, trajet carrier, voyage carrier, plan de voyage carrier, combien de sauts sur la route carrier, sauts restants carrier, nombre de sauts route carrier, sauts restants sur le carrier", CARRIER_ROUTE_ANALYSIS.getAction());
        map.put("route carrier, où va le carrier, ou va le carrier, prochain saut carrier, destination carrier, cap carrier, destination finale carrier, où se dirige le carrier, ou se dirige le carrier", CARRIER_ROUTE.getAction());
        map.put("tritium carrier, carburant carrier, combien de tritium, réserve tritium, reserve tritium, niveau tritium, niveau carburant carrier, statut tritium carrier", CARRIER_TRITIUM_SUPPLY.getAction());
        map.put("statut carrier, finances carrier, solde carrier, aperçu carrier, apercu carrier, fonds carrier, combien de temps peut fonctionner le carrier, statut carburant carrier, portée de saut carrier, portee de saut carrier, portée carrier avec tritium actuel, portee carrier avec tritium actuel", CARRIER_STATUS.getAction());
        map.put("ETA carrier, eta carrier, quand arrive le carrier, combien de temps avant le carrier, arrivée carrier, arrivee carrier, heure d'arrivée carrier, heure d'arrivee carrier, quand saute le carrier, heure saut carrier", CARRIER_ETA.getAction());
