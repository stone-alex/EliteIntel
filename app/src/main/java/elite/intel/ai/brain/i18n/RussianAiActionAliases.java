...
public class RussianAiActionAliases implements AiActionAliasProvider {
    ...
    public void addAliases(Map<String, String> map, Status status, boolean isDryRun) {
        ...
        map.put("сбрось взгляд, сбрось направление взгляда, взгляд по умолчанию, вид по умолчанию, сбрось head look", RESET_HEAD_LOOK.getAction());
        ...
        map.put("куда летит авианосец эскадрильи, пункт назначения авианосца эскадрильи, конечная точка авианосца эскадрильи, курс авианосца эскадрильи", SQUADRON_CARRIER_ROUTE.getAction());
        ...
        map.put("тритий авианосца, топливо авианосца, сколько трития, уровень трития, резерв трития", FLEET_CARRIER_TRITIUM_SUPPLY.getAction());
        ...
        map.put("в какой системе я нахожусь, в какой системе мы находимся, какая текущая система, где мой корабль, где мы сейчас, наше местоположение", CURRENT_LOCATION.getAction());
