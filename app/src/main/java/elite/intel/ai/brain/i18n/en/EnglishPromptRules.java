    ...
    public String disambiguationHints() {
        ...
        return
                "- \"activate\" (exact standalone word only, nothing else meaningful in input) → " + activate + ". \"toggle [X]\", \"engage [X]\", \"enable [X]\" and other non-activate verbs are NOT \"activate\" - never map these to " + activate + "\n"
                        ...
                        + "- bio scans: \"what organisms are here / exobiology samples / organics on this planet / organics still to scan / organics left to scan\" → " + Queries.EXOBIOLOGY_SAMPLES.getAction() + "\n"
                        ...
                        + "- organics / biology / exobiology on a planet or here → " + Queries.EXOBIOLOGY_SAMPLES.getAction() + ", NOT geo/materials\n"
