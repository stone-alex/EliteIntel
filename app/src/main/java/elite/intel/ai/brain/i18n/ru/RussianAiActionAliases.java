...
public class RussianAiActionAliases implements AiActionAliasProvider {
    ...
    public void addAliases(Map<String, String> map, Status status, boolean isDryRun) {
        ...
        map.put("экзобиологические образцы, Какие биосканирования мы завершили?, биологические образцы, органика в локации, какие организмы, что осталось сканировать, оставшиеся организмы, прогресс экзобиологии, что просканировано здесь, какая органика на этой планете", EXOBIOLOGY_SAMPLES.getAction());
