...
public class AudioCalibrator {
    ...
    private static final double DEFAULT_RMS_THRESHOLD_HIGH = 0; // Fallback
    private static final double DEFAULT_RMS_THRESHOLD_LOW = 0; // Fallback for budget mics
    ...
    public static RmsTupple<Double, Double> calibrateRMS(int sampleRateHertz, int bufferSize) {
        ...
        double adjustedLowThreshold = lowThreshold + 5;
