...
```java
   elite.intel.ai.search.spansh.client.SpanshClient
```
...
For examples see: 
```java 
elite.intel.ai.search.spansh.stellarobjects.StellarObjectSearchRequestDto;
elite.intel.ai.search.spansh.stellarobjects.StellarObjectSearchResponseDto;
```
