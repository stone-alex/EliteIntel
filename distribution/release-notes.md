...
### bug fixes / features:
- Added Spansh, EDSM, INTRA and LLM request/response to the websocket. See web-socket-monitor.html in the installation dir
...
- Changed how galaxy and local map closes.
...
- Refactoring hands/gameapi package for clean separation of concerns. Code maintenance. No impact on functionality.
...
- JRE resolution on Linux during update.
